...
// ====================================================================
// DISPLAY CONFIGURATION - CHANGE THIS FOR YOUR DISPLAY!
// ====================================================================

// select the display class (only one), matching the kind of display panel
#define GxEPD2_DISPLAY_CLASS GxEPD2_BW    // Black & White displays (most common)
//#define GxEPD2_DISPLAY_CLASS GxEPD2_3C   // 3-Color displays (Black, White, Red/Yellow)
//#define GxEPD2_DISPLAY_CLASS GxEPD2_4C   // 4-Color displays
//#define GxEPD2_DISPLAY_CLASS GxEPD2_7C   // 7-Color displays

// select the display driver class (only one) for your panel
// ⚠️ IMPORTANT: Uncomment ONLY the line that matches your display model!
// Find your display model number on the back of your display

// === COMMON DISPLAYS (Recommended for beginners) ===
#define GxEPD2_DRIVER_CLASS GxEPD2_154_D67 // 1.54" 200x200 - GDEH0154D67 (MOST COMMON)
//#define GxEPD2_DRIVER_CLASS GxEPD2_213_B73 // 2.13" 122x250 - GDEH0213B73 
//#define GxEPD2_DRIVER_CLASS GxEPD2_290_T5D // 2.9"  128x296 - GDEW029T5D
//#define GxEPD2_DRIVER_CLASS GxEPD2_420_T94 // 4.2"  400x300 - GDEH042T94
...
// Change GxEPD2_DISPLAY_CLASS to GxEPD2_3C above if using these
...
// === 4-COLOR DISPLAYS ===
// Change GxEPD2_DISPLAY_CLASS to GxEPD2_4C above if using these
...
// === 7-COLOR DISPLAYS ===
// Change GxEPD2_DISPLAY_CLASS to GxEPD2_7C above if using these  
...
// ====================================================================
// HARDWARE CONFIGURATION - Usually no need to change this
// ====================================================================
